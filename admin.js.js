...
function requestCard(r) {
  ...
  const methodLabel = { mpesa: "M-Pesa", paypal: "PayPal", manual: "Manual" }[r.method] || r.method;
  const approveLabel = currentType === "deposit" ? "Approve (received)" : "Approve (paid)";
...
async function actOnRequest(id, action) {
  const verb = currentType === "deposit"
    ? (action === "approve" ? "confirm you received this deposit and credit the balance" : "reject this deposit")
    : (action === "approve" ? "mark this as paid" : "reject and refund this");
